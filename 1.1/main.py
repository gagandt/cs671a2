...
layer_conv1, weights_conv1 = new_conv_layer(input=x_image, num_input_channels=1, filter_size=7, num_filters=32, name ="conv1")

# RelU layer 1
layer_relu1 = new_relu_layer(layer_conv1, name="relu1")

# Pooling Layer 2
layer_pool2 = new_pool_layer(layer_relu1, name="pool2")
...
layer_fc1 = new_fc_layer(layer_flat, num_inputs=num_features, num_outputs=1024, name="fc1")
